...
void frmProgressBarPercent::initForm()
{
    ...
    FlatUI::Instance()->setRadioButtonQss(ui->rbtnClockWise, 8, "#D7DBDE", "#1ABC9C");
    FlatUI::Instance()->setRadioButtonQss(ui->rbtn, 8, "#D7DBDE", "#1ABC9C");
    FlatUI::Instance()->setRadioButtonQss(ui->rbtnArc, 8, "#D7DBDE", "#3498DB");
    FlatUI::Instance()->setRadioButtonQss(ui->rbtnPolo, 8, "#D7DBDE", "#3498DB");
    FlatUI::Instance()->setRadioButtonQss(ui->rbtnArcPolo, 8, "#D7DBDE", "#00FFFF");
    FlatUI::Instance()->setRadioButtonQss(ui->rbtnWave, 8, "#D7DBDE", "#3498DB");
