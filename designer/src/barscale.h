...
class QDESIGNER_WIDGET_EXPORT BarScale : public QWidget
#else
class BarScale : public QWidget
#endif
...
public:
    ...
    explicit BarScale(QWidget *parent = 0);
...
public slots:
    ...
    //设置告警刻度颜色
    void setAlarmScaleColor(QColor alarmScaleColor);
