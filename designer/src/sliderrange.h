...
class QDESIGNER_WIDGET_EXPORT SliderRange : public QWidget
#else
...
public Q_SLOTS:
    ...
    //设置滑块背景所占比例
    void setSliderBgPercent(SliderBgPercent sliderBgPercent);
    //设置滑块所占比例
    void setSliderPercent(SliderPercent sliderPercent);
